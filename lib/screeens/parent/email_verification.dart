                ...
                child: BackdropFilter(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("EMAIL VERIFICATION", style: TextStyle(color: Colors.black , fontWeight: FontWeight.bold,fontFamily: "Quantico" , fontSize: 18),),

                        SizedBox(height: 10),
                        Text("Enter the code, it’s in your inbox,shahidtalha500@gmail.com",textAlign: TextAlign.center, style: TextStyle(color: Colors.black , fontWeight: FontWeight.bold,fontFamily: "Quantico" , fontSize: 12),),
                        ...
                        SizedBox(height: 10),
                        ElevatedButton(
                          onPressed: ()=>{Navigator.pushNamed(context, '/childConnection')},
